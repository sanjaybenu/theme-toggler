  ...
  return (
    <Box sx={{ width: "100%" ,position:"fixed, , bottom: 0, left: 0, right: 0 "}}>
      ...
      > 
        ...
        <Link href="https://studio.youtube.com/channel/UCA4mc_H-tqG-aK6kElG2sGQ" target="_blank" rel="noreferrer" ><BottomNavigationAction label="Youtube" icon={<YouTubeIcon/>} /></Link>
        <Link href="https://www.instagram.com" target="_blank" rel="noreferrer" ><BottomNavigationAction label="Instagram" icon={<InstagramIcon />} /></Link>
      </BottomNavigation>
    </Box>
  );
}